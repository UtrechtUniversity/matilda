...
# y <- rnorm(100)
# df <- data.frame(y = y, t = 1:length(y))
...
ggplot2::ggsave("images/banner.svg")
```
...
::: grid
::: g-col-6
<center>[Get started](/quiz.html){.btn .btn-outline-primary .btn role="button"}</center>
:::

::: g-col-6
<center>[Meet our experts](/experts.html){.btn .btn-outline-primary .btn role="button"}</center>
:::
:::
