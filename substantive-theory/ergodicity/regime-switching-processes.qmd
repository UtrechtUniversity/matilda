...
Many psychological processes switch between two or more different **regimes**. For example, an individual can alter between healthy and depressed states over a period of time, or an emotion process may switch between negative, neutral and positive moods.
