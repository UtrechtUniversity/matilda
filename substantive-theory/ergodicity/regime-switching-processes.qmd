...
## Regime switching timing

The regime switching mechanism may only be understood if regime switching takes place during the measurement period. Therefore, it is important to think about the timescale of the regime switching process. If regime switching occurs more frequently than the frequency of the measurements, regime switches will be missed.

::: {.callout-tip collapse="true"}

## Example: Social anxiety

Flora tracks daily social anxiety in a single participant. At the end of each day in the study, the participant reports how socially anxious they felt that day on average. Flora finds that the participant's social anxiety is very stable over time. However, the participant feels very distinct states of anxiety or no anxiety during the day depending on whether or not they are in a social situatio which is not captured in the daily average.
:::
