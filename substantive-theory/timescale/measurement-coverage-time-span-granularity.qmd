...
categories: ['Substantive theory', 'Timescale', 'Granularity', 'Time span', 'Time interval', 'Number of measurements', 'Time frame']
...
The time span and granularity of a measurement design to a large extent determine at which timescales we can study a given process. In the following, we discuss three important design aspects that determine the time span and granularity of a study.
...
-   [External Validity for ILD]
-   [How many repeated measurements do I need?]
-   [Relation constructs measured at different timescales](relating-constructs-timescales.qmd)
-   [Measurement Burst Designs]
-   [Measurement Burst Designs: Event Contingent Bursts]
-   [Remembering vs Experiencing Self]
-   [Retrospective Assessment, Ecological Retrospective Assessment, Ecological Momentary Assessment]
