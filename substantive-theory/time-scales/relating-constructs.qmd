...
Ideally, we want the frequency of measurements for psychological constructs to match the timescale at which they develop (see: [Time Scales: Landing Page](../time-scales.qmd)). 
...
-   [Event contingent constructs](event-relations.qmd)

-   [Regimes-switching constructs](regime-switches.qmd)
:::
...
-   [Time Scales: Landing Page](../time-scales.qmd)
