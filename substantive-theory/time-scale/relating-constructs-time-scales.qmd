...
The timescale at which psychological constructs develop over time give rise to substantive considerations for the measurement frequency of such constructs (see: [Key design aspects related to time scales: time frame, interval, number of measurements](../time-scale/measurement-coverage-time-span-granularity.qmd)). Oftentimes, researchers are interested in studying (the relations between) multiple constructs that are or need to be measured at different time scales in some way or form.
