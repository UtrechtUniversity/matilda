...
This is the landing page for everything related to the <i> measurement model </i> that applies to your [constructs](../theory/your-study/constructs.qmd) and [measurement instrument](instrument.qmd).
...
-   [The measurement error autoregressive model](validation/reliability-single-item-measures.qmd#the-measurement-error-autoregressive-model)
