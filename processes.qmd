...
This distinction should not be taken as categorical or absolute, and it tends to be related to the [timescale](theory/timescale.qmd) at which we are focusing. There are many examples where we may see a that a process is stationary in the short run, but is characterized by development if we zoom out further and consider a longer period.
